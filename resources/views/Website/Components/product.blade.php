    ...
    <div class="wrapper">
        <div class="product-content">
            ...
            <div class="product-info">
                <h3>Foundation Beshop</h3>
                <span class="product-stock">in stock</span>
                <span class="product-num">SKU: IN1203</span>
                <span class="product-price"><span>$265.95</span>$200.95</span>
                <p>Universal foundation masks skin imperfections and gives it a matte finish, remaining
                    completely invisible on the face. The foundation is suitable for any skin type. Thanks
                    to a unique combination of pigments, the foundation adapts perfectly to even the
                    smallest features of skin tone, creating an even and natural tone. </p>
                ...
                <div class="product-buttons">
                    <a href="#" class="btn btn-icon"><i class="icon-cart"></i> cart</a>
                    <a href="#" class="btn btn-grey btn-icon"><i class="icon-heart"></i> wish</a>
                </div>
            </div>
        </div>
